...
//        int queueId msg.getQueueId();
        ...
        if (tranType == MessageSysFlag.TRANSACTION_NOT_TYPE
            ...
            // Delay Delivery
            // 如果消息延迟级别大于0，那么就将消息的Topic设置为SCHEDULE_TOPIC_XXXX，队列ID设置为延迟级别对应的队列ID
        ...
        try {
            ...
            // 如果 mappedFile 为空或者已经满了，就创建一个新的 mappedFile
